...
export default function Home() {
    ...
    return (
        <div className={styles.container}>
            <img src="bg-main-desktop.png" className={styles.desktopBg} alt="" />
            <img src="bg-main-mobile.png" className={styles.mobileBg} alt="" />
            <div className={styles.cardFront}>
              <img src="bg-card-front.png" alt="" width="500px" height="275px" />
            ...
            <div className={styles.cardBack}>
              <img src="bg-card-back.png" alt="" width="500px" height="275px" />
